<template>
  <v-app>
    <div id="body1" :class="details == false ? 'details':''"   v-on:click="doSomething">
<div class="background">
	...
	<div class="info">Click to toggle details view  {{ details }}</div>
</div>
    </div>
  </v-app>
</template>
...
export default {
  ...
  mounted() {
    VanillaTilt.init(document.querySelectorAll(".container1 .card"), {
      max: 25,
      speed: 400,
      glare: true,
      "max-glare": 1,
